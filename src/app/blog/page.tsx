    ...
    <div className=" min-h-screen bg-Primary">
      ...
      <div className="max-w-7xl flex-col flex min-h-screen mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex mb-12 items-center relative">
          <Link
            href="/"
            className="absolute top-0 h-[50%] w-fit rounded-2xl transition duration-500  text-Text flex items-center justify-start cursor-pointer hover:bg-Text/90 hover:text-Primary bg-Secondary p-2 font-medium max-h-7"
          >
            <FiArrowLeft className="mr-1" />
            Portfolio
          </Link>
          <div className="text-center flex-1">
            <h1 className="text-4xl font-bold text-Text mb-4 sm:mt-0 mt-7">My Blog</h1>
        ...
        {/* Search Bar */}
        <div className="max-w-2xl w-4/5 mx-auto mb-12 ">
          <div className="relative">
            <input
              type="text"
              placeholder="Search articles... (not implemented yet)"
              className="pl-10 w-full px-4 py-3 rounded-lg bg-Secondary/10 border border-border text-Text placeholder-Muted focus:outline-none focus:ring-2 focus:ring-border"
            />
