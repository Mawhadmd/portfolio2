      ...
      <div className="w-full rounded-md flex flex-col sm:flex-row gap-4 justify-center items-center">
        ...
        <Link href="/blog" passHref target="_blank">
          <motion.div
            ...
            whileTap={{ scale: 0.95 }}
          >
            <span className="absolute inset-0 w-full h-full transition duration-300 ease-out transform -translate-x-1 -translate-y-1 bg-blue-400/30 group-hover:translate-x-0 group-hover:translate-y-0"></span>
            <span className="absolute inset-0 w-full h-full bg-blue-400/20 border-2 border-blue-400/30 group-hover:bg-blue-400/30"></span>
            <span className="relative flex items-center gap-2">
