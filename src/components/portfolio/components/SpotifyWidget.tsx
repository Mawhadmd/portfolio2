...
const SpotifyWidget = ({ ThemeColor }: Props) => {
  ...
  return (
    <div className=" sm:pr-1 p-4 flex bg-Secondary h-16 box-border items-center gap-3 w-full rounded-md">
      {data ? (
        <>
        ...
        <>
          <div>
            <svg
              aria-hidden="true"
              className="size-5 text-neutral-200 animate-spin dark:text-neutral-600 fill-blue-600"
              viewBox="0 0 100 101"
              fill="none"
